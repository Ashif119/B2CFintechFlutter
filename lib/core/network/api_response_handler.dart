...
class ApiResponseHandler {
  static BaseRes parseBaseRes(Response response) {
    if (response.isOk && response.body != null) {
      ...
      return BaseRes(success: false, message: getErrorMessage(response));
    }
  }
  ...
  static BaseDataRes<T> parse<T>(
    ...
    if (response.isOk && response.body != null) {
      ...
      return BaseDataRes<T>(success: false, message: getErrorMessage(response));
    }
  }
  ...
  static BaseDataRes<List<T>> parseList<T>(
    ...
    if (response.isOk && response.body != null) {
      ...
      return BaseDataRes(success: false, message: getErrorMessage(response));
    }
  }
